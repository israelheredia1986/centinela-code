/* CENTINELA CODE — ARRANQUE DEL MOTOR ÚNICO DE CONSULTA */
(function(){
  "use strict";
  ...
  // Motor único y literal. La versión cambia para evitar la caché del PWA/navegador.
  loadScript('centinelaInstantSearchScript','./buscador-instantaneo.js?v=20260916g');
  ...
  const st=document.createElement('style');st.id='cc-dashboard-three-actions-final';
