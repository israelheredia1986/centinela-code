...
(function(){
  ...
  loadScript('centinelaNormativaUnificadaScript','./normativa-unificada.js?v=20260905k');
  loadScript('centinelaNormativaCompatScript','./normativa-compat.js?v=20260905k');
  loadScript('centinelaNormativaOficialScript','./normativa-oficial.js?v=20260905l');
  loadScript('centinelaEspectaculosFusionScript','./normativa-espectaculos-fusion.js?v=20260905f');
  loadScript('centinelaNormativaEstructuraScript','./normativa-estructura.js?v=20260905e');
  loadScript('centinelaNormativaIconosScript','./normativa-iconos.js?v=20260905d');
