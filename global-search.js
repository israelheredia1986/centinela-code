...
(function(){
  ...
  loadScript('centinelaNormativaUnificadaScript','./normativa-unificada.js?v=20260905h');
  loadScript('centinelaNormativaCompatScript','./normativa-compat.js?v=20260905h');
  loadScript('centinelaNormativaOficialScript','./normativa-oficial.js?v=20260905i');
  loadScript('centinelaEspectaculosFusionScript','./normativa-espectaculos-fusion.js?v=20260905c');
  loadScript('centinelaNormativaEstructuraScript','./normativa-estructura.js?v=20260905a');
