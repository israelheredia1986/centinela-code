...
(function(){
  ...
  (async()=>{
    ...
    await loadScript('centinelaDefinitiveSearchScript','./buscador-definitivo.js?v=20260916b');
    await loadScript('centinelaSearchFixScript','./buscador-fix.js?v=20260916a');
  })();
