...
(function(){
  ...
  loadScript('centinelaNormativaUnificadaScript','./normativa-unificada.js?v=20260905i');
  loadScript('centinelaNormativaCompatScript','./normativa-compat.js?v=20260905i');
  loadScript('centinelaNormativaOficialScript','./normativa-oficial.js?v=20260905j');
  loadScript('centinelaEspectaculosFusionScript','./normativa-espectaculos-fusion.js?v=20260905d');
  loadScript('centinelaNormativaEstructuraScript','./normativa-estructura.js?v=20260905b');
  loadScript('centinelaNormativaIconosScript','./normativa-iconos.js?v=20260905a');
