...
$("homeNewActaButton")?.addEventListener("click", () => { activarSeccion("actas"); setTimeout(() => abrirEditorActa(), 80); });
...
boton.textContent = textoOriginal || "n";
}
}
},
(error) => {
...
botonDictadoActivo.textContent = "n";
}
...
function renderizarActasHome() {
const contenedor = $("homeActasList");
...
return `<button type="button" class="home-acta-row" data-home-acta="${escaparHTML(acta.id || "")}"><span class="home-acta-number">ACTA-${escapar
}
...
>
n Ver normativa online (BOE/BOJA)
</a>
` : ""}
${leyItem.nota ? `
<p>
...
<div class="normativa-card">
<div class="normativa-icon">
${VIOLENCIA_GENERO_ICONOS[leyItem.id] || "n"}
</div>
<div class="normativa-info">
<h3>
${escaparHTML(leyItem.ley || "")}
