/* ============================================================
   CENTINELA CODE — SERVICE WORKER V41
   Constitución Española: acceso visible garantizado.
   ============================================================ */
const CACHE_NAME="centinela-code-v41-constitucion-visible";
const ARCHIVOS=[
...
(function(){
  ...
  function host(){return document.getElementById('section-normativa')||document.querySelector('.app-section[id*="normativa"]');}
...
self.addEventListener('install',event=>{self.skipWaiting();event.waitUntil(caches.open(CACHE_NAME).then(c=>c.addAll(ARCHIVOS).catch(()=>{})));});
