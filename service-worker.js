/* ============================================================
   CENTINELA CODE — SERVICE WORKER V27
   Actualización forzada del buscador V4 y comercio ambulante.
   ============================================================ */
const CACHE_NAME="centinela-code-v27-search-v4";
const ARCHIVOS=[
  ...
  "./buscadores.js?v=20260904-search-v4","./manifest.json",
  "./data/lopsc.json","./data/infracciones.json","./data/infracciones_trafico.json","./data/ordenanzas.json","./data/codigo_penal.json",
  "./data/normativa_menores.json","./data/normativa_violencia_genero.json","./data/normativa_animales.json","./data/normativa_trafico.json",
  "./data/ley_2_86.json","./data/lecrim.json","./data/extranjeria.json","./data/seguridad_privada.json","./data/espectaculos_publicos.json",
  "./data/comercio_ambulante.json","./data/medio_ambiente_ruidos.json","./data/reglamento_armas.json","./data/policias_locales_andalucia.json",
...
async function prepararHtml(response){
  ...
  try{
    ...
    const replaceScript=(source,name)=>{
      const re=new RegExp('<script[^>]*'+name.replace('.','\\.')+'[^>]*><\\/script>','i');
      const tag='<script defer src="./'+name+'"></script>';
